...
//                 {/* 1. HERO SECTION */}
//                 <section className="max-w-5xl mx-auto px-6 text-center mb-12 md:mb-20">
//                     <motion.div
...
//                 <section className="max-w-7xl mx-auto px-6 md:mb-16 mb-10">
...
//                                 <div className="text-3xl md:text-4xl font-heading font-extrabold text-foreground mb-2">{stat.value}</div>
...
//                 {/* 4. CORE VALUES */}
//                 <section className="max-w-7xl mx-auto md:mb-16 mb-10 px-6">
//                     <div className="text-center px-6 mb-10">
//                         <h2 className="font-heading font-bold text-3xl md:4xl text-foreground mb-4">Our Core Values</h2>
...
//                 {/* 5. TEAM */}
//                 <section className="max-w-7xl mx-auto px-6 md:mb-20 mb-12">
...
//                             <h2 className="text-4xl md:text-5xl font-heading font-extrabold mb-6 text-foreground">
...
function Counter({ value }: { value: string }) {
    ...
    // সংখ্যা এবং টেক্সট আলাদা করা (যেমন: "10k+" -> সংখ্যা: 10, সাফিক্স: "k+")
    ...
    // যদি কোনো সংখ্যা না থাকে, সাধারণ টেক্সট দেখাবে
    ...
    return (
        <main className="min-h-screen bg-background text-foreground font-body transition-colors duration-300 flex flex-col relative overflow-x-hidden">
            ...
            <div className="flex-grow relative z-10 pt-32 pb-20">
                ...
                {/* 2. STATS STRIP (Glassmorphism with Counters) */}
                <section className="max-w-7xl mx-auto px-6 md:mb-16 mb-10">
                    <div className="bg-card/50 backdrop-blur-md border border-border rounded-2xl p-10 shadow-lg grid grid-cols-2 md:grid-cols-4 gap-8 text-center relative overflow-hidden">
                        {/* Decorative background for the card */}
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-primary/5 to-transparent pointer-events-none" />
                        ...
                        {stats.map((stat, i) => (
                            <div key={i} className="relative z-10">
                                <div className="text-3xl md:text-4xl font-heading font-extrabold text-foreground mb-2">
                                    {/* Using the Custom Counter Component */}
