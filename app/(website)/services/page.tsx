...
export default function ServicesPage() {
  ...
  const [country, setCountry] = useState(
    countries.find((c) => c.iso === "BD") || countries[0],
  );
  ...
  const budgetPercentage =
    ((budget - minBudget) / (maxBudget - minBudget)) * 100;
  ...
  return (
    <main className="min-h-screen text-foreground font-body transition-colors duration-300 flex flex-col relative">
      ...
      <section className="pt-30 md:pt-40 pb-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-heading font-extrabold mb-6 tracking-tight text-foreground leading-tight">
              ...
              <br className="hidden md:block" /> For Your Success
            </h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10">
              From pixel-perfect themes to complex web applications, we provide
              end-to-end development services to help your business grow.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                desc: "Custom websites built with Next.js, React, and Node.",
              },
              {
              ...
              },
              {
                ...
                title: "UI/UX Design",
                desc: "User-centric design that converts visitors into customers.",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
      ...
      <section className="relative z-10 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <div className="text-center mb-10">
            ...
            >
              From the first conversation to final delivery, we ensure a
              transparent and collaborative journey.
            </motion.p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-2 md:gap-8 relative">
      ...
      <div className="flex-grow py-16 py-12 relative z-10" id="start-project">
        <div className="max-w-4xl mx-auto px-6 mb-10">
          <div className="text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-lg mx-auto leading-relaxed">
              Tell us about your project. We will analyze your needs and provide
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {["customization", "new", "bugfix"].map((type) => (
                  <label key={type} className="cursor-pointer group relative">
                    ...
                    />
                    <div
                      className={`h-full p-6 rounded-xl border transition-all duration-200 backdrop-blur-sm ${selectedType === type ? "bg-primary/5 border-primary shadow-[0_0_20px_rgba(var(--primary),0.15)]" : "bg-card/80 border-border hover:border-primary/50 hover:bg-secondary/50"}`}
                    >
                      <div
                        className={`w-12 h-12 rounded-lg flex items-center justify-center mb-4 ${type === "customization" ? "bg-blue-500/10 text-blue-500" : type === "new" ? "bg-purple-500/10 text-purple-500" : "bg-red-500/10 text-red-500"}`}
                      >
                        {type === "customization" ? (
                          <Wrench size={24} />
                        ) : type === "new" ? (
                      ...
                      <h3 className="font-bold text-foreground mb-2 capitalize">
                        {type === "new"
                          ? "New Project"
                          : type === "bugfix"
                            ? "Bug Fix / Help"
                      ...
                      {selectedType === type && (
                        <div className="absolute top-4 right-4 w-5 h-5 bg-primary rounded-full flex items-center justify-center text-primary-foreground">
              ...
              <div className="bg-card/80 backdrop-blur-sm border border-border rounded-xl p-8 shadow-sm">
                <div className="mb-10">
                  ...
                  <input
                    ...
                    className="w-full h-2 rounded-lg appearance-none cursor-pointer outline-none focus:outline-none 
                                        [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-5 [&::-webkit-slider-thumb]:h-5 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-primary [&::-webkit-slider-thumb]:shadow-md [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-white
                                        [&::-moz-range-thumb]:w-5 [&::-moz-range-thumb]:h-5 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-primary [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-white"
                    style={{
                      // Dynamic linear gradient: Blue (primary) for filled part, Gray (secondary) for empty part
                      background: `linear-gradient(to right, #3b82f6 ${budgetPercentage}%, var(--secondary, #e2e8f0) ${budgetPercentage}%)`,
                    }}
                  />
                  {/* ------------------- */}
            ...
            <section className="relative z-20">
              ...
              <div className="space-y-4">
                ...
                <div
                  ...
                  className={`border border-dashed border-border rounded-lg p-8 text-center transition-colors cursor-pointer group relative bg-card/50 backdrop-blur-sm ${isUploading ? "opacity-70 cursor-wait bg-secondary/30" : "hover:bg-secondary/50"}`}
                >
                  <input
                    type="file"
                    ref={fileInputRef}
                  ...
                  {isUploading ? (
                    ...
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-sm text-foreground font-bold mb-1 truncate max-w-[200px]">
                        {attachment.name}
                      </p>
                      <button
