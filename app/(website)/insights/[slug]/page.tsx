...
export default async function InsightDetailsPage(props: {
  ...
  const authorAvatarUrl =
    dbImage ||
    `https://ui-avatars.com/api/?name=${encodeURIComponent(post.author)}&background=random&color=fff&size=128`;
  ...
  return (
    <main className="min-h-screen bg-background text-foreground font-body transition-colors duration-300 flex flex-col relative">
      ...
      <div className="flex-grow pt-32 pb-16 relative z-10">
        ...
        {/* Header */}
        <header className="md:max-w-4xl max-w-5xl mx-auto px-6 mb-12 text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-heading font-extrabold text-foreground mb-6 leading-tight">
            {post.title}
          </h1>
        ...
        {/* Content Layout */}
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 relative mb-0 md:mb-10">
          {/* Left: Sticky Share */}
        ...
        {/* CTA Section */}
        <div className="max-w-4xl mx-auto px-6 mb-12 md:mb-16 relative z-10">
          <div className="bg-secondary/50 border border-border rounded-2xl p-10 text-center relative overflow-hidden">
            ...
            <p className="text-muted-foreground mb-8 max-w-md mx-auto">
              Save months of development time with our premium Next.js
              templates. Built for performance and scale.
            </p>
            <Link
              href="/products"
              className="group inline-flex items-center gap-2 px-8 py-3 bg-primary text-primary-foreground font-bold rounded-xl hover:bg-primary/90 transition-all shadow-lg shadow-primary/20"
            >
              Explore Templates{" "}
              <ArrowRight
                size={18}
        ...
        {relatedPosts.length > 0 && (
          <div className="max-w-7xl mx-auto px-6 border-t border-border pt-12 md:pt-16">
