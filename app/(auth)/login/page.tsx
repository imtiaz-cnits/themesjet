...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            // If successful, the server action handles the redirect to /user/dashboard automatically
        } catch (err) {
                ...
                <div className="absolute inset-0 flex items-center justify-center z-10">
                    <div className="relative w-[500px] h-[500px]">
                        ...
                        <motion.div
                            ...
                            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-background/80 backdrop-blur-2xl border border-white/10 rounded-3xl flex flex-col items-center justify-center shadow-2xl p-8 text-center"
                        >
