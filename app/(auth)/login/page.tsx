                ...
                <div className="max-w-md w-full mx-auto mt-16 lg:mt-0">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-8">
                        <button
                            ...
                            className="flex items-center justify-center gap-2 py-2.5 bg-card border border-border rounded-lg hover:bg-secondary transition-all text-sm font-bold text-foreground"
                        >
