...
import { register } from "@/actions/auth"; // Import the server action
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center relative z-10 p-6 lg:p-12 xl:p-24 overflow-y-auto">
                ...
                <div className="max-w-md w-full mx-auto mt-16 lg:mt-0">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-8">
                        <button type="button" className="flex items-center justify-center gap-2 py-2.5 bg-card border border-border rounded-lg hover:bg-secondary transition-all text-sm font-bold text-foreground">
                            {/* Google SVG */}
                    ...
                    <form className="space-y-5" onSubmit={handleSignup}>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        type="text"
                                        required
                                        className="w-full bg-input/10 border border-input rounded-lg pl-10 pr-4 py-3 text-foreground outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all placeholder:text-muted-foreground/50"
                                        placeholder="John"
                                    />
                        ...
                        <button
                            type="submit"
                            disabled={isPending}
                            className="w-full bg-primary hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed text-primary-foreground font-bold py-3.5 rounded-lg transition-all shadow-lg shadow-primary/20 flex items-center justify-center gap-2"
                        >
