...
import { Github, Check, ArrowRight, ArrowLeft, User, Mail, Lock, AlertCircle } from "lucide-react";
import { register, socialLogin } from "@/actions/auth"; // Import both actions
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center relative z-10 p-6 lg:p-12 xl:p-24 overflow-y-auto">
                ...
                <div className="max-w-md w-full mx-auto mt-16 lg:mt-0">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-8">
                        <button type="button" onClick={() => socialLogin("google")} className="flex items-center justify-center gap-2 py-2.5 bg-card border border-border rounded-lg hover:bg-secondary transition-all text-sm font-bold text-foreground">
                        ...
                        <button type="button" onClick={() => socialLogin("github")} className="flex items-center justify-center gap-2 py-2.5 bg-card border border-border rounded-lg hover:bg-secondary transition-all text-sm font-bold text-foreground">
                    ...
                    <form className="space-y-5" onSubmit={handleSignup}>
                        ...
                        <div className="flex items-start gap-3">
                            <div className="flex items-center h-5">
                                <input id="terms" type="checkbox" required className="w-4 h-4 rounded border-input bg-input/10 text-primary focus:ring-primary accent-primary" />
                            </div>
                        ...
                        <button type="submit" disabled={isPending} className="w-full bg-primary hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed text-primary-foreground font-bold py-3.5 rounded-lg transition-all shadow-lg shadow-primary/20 flex items-center justify-center gap-2">
                            {isPending ? "Creating Account..." : <>Create Account <ArrowRight size={18} /></>}
                        </button>
                    </form>
