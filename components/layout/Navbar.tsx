                ...
                <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
                    ...
                    <Link href="/" className="flex items-center gap-3 group z-50 max-w-[200px]">
                        <svg className="h-8 w-auto" viewBox="0 0 3006 542" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs>
                                <linearGradient id="sidebar_logo_gradient" x1="250.846" y1="20.731" x2="250.846" y2="522.422" gradientUnits="userSpaceOnUse">
                        ...
                        {navLinks.map((link) => {
                            ...
                            return (
                                <Link
                                    key={link.name}
                                    href={link.href}
                                    className={`${isActive ? activeClass : inactiveClass} transition-colors`}
                                >
                                    {link.name}
                                </Link>
                            );
                            ...
                            {navLinks.map((link, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            {link.name}
                                            <ChevronRight className={`w-6 h-6 transition-all ${isActive ? 'text-primary translate-x-0 opacity-100' : 'opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0'}`} />
                                        </Link>
                                    </motion.div>
                                );
                            })}
