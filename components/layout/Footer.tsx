        ...
        <footer className="relative border-t border-border pt-20 pb-10 text-sm transition-colors duration-300 overflow-hidden bg-secondary dark:bg-card">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        <Link href="/" className="flex items-center gap-3 group z-50 mb-6">
                            ...
                            <svg className="h-10 w-auto" viewBox="0 0 3006 542" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <defs>
                                    <linearGradient id="footer_logo_gradient" x1="250.846" y1="20.731" x2="250.846" y2="522.422" gradientUnits="userSpaceOnUse">
                    ...
                    {/* Marketplace Links */}
                    <div>
                        <h4 className="text-foreground font-bold font-heading mb-6 text-base">Marketplace</h4>
                        <ul className="space-y-3 text-muted-foreground font-body">
                            <li><Link href="#" className="hover:text-primary transition-colors">HTML Templates</Link></li>
                            <li><Link href="#" className="hover:text-primary transition-colors">React Templates</Link></li>
                            <li><Link href="#" className="hover:text-primary transition-colors">PHP Scripts</Link></li>
                            <li><Link href="#" className="hover:text-primary transition-colors">UI Kits</Link></li>
                        </ul>
                    </div>
                    ...
                    {/* Newsletter */}
                    <div>
                        <h4 className="text-foreground font-bold font-heading mb-6 text-base">Newsletter</h4>
                        <p className="text-muted-foreground mb-4 font-body">Get the latest releases and discounts.</p>
                ...
                <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-muted-foreground font-body">© 2026 Themes Jet | All rights reserved.</p>
