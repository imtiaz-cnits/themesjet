...
import { Twitter, Github, Dribbble, ArrowRight } from "lucide-react";
...
const blobVariantsDelayed: Variants = {
  initial: { scale: 1, opacity: 0.3, x: 0, y: 0 },
  animate: {
    scale: [1, 1.2, 1],
    opacity: [0.3, 0.6, 0.3],
...
export default function Footer() {
  return (
    <footer className="relative border-t border-border md:pt-20 pt-12 pb-10 text-sm transition-colors duration-300 overflow-hidden bg-background dark:bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-8 md:mb-16">
          {/* Brand Column */}
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center gap-3 group z-50 mb-6">
              ...
              <svg
                ...
                viewBox="0 0 3006 542"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
                <circle cx="251" cy="271.5" r="250.5" fill="white" />
                <path
                  d="M409.282 77.0894C465.678 123.087 501.691 193.126 501.691 271.577C501.691 410.115 389.384 522.422 250.846 522.422C220.546 522.422 191.5 517.049 164.61 507.206C247.217 352.865 308.006 245.757 409.282 77.0894ZM250.846 20.731C310.833 20.731 365.901 41.7885 409.064 76.9136L361.028 103.322L297.854 215.249L337.845 118.552C308.255 138.099 295.262 152.525 276.734 182.735C210.621 299.868 182.24 364.209 133.119 383.973L88.582 462.877C87.3117 461.799 86.0521 460.708 84.8037 459.605L112.308 391.961C82.2086 403.206 64.942 407.079 37.541 403.643C13.7421 365.286 3.17389e-05 320.036 0 271.577C0 133.038 112.308 20.731 250.846 20.731Z"
                  fill="url(#footer_logo_gradient)"
                />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M424.936 365.21C430.483 378.713 424.822 394.248 411.923 400.917L281.174 468.521L261.211 429.272L378.902 368.42L343.497 282.236L383.915 265.356L424.936 365.21Z"
                  fill="white"
                />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M64.3169 217.296C58.7696 204.068 64.4312 188.85 77.3301 182.317L208.079 116.093L228.042 154.541L110.351 214.151L145.756 298.576L105.338 315.111L64.3169 217.296Z"
                  fill="white"
                />
                <path
                  d="M262.456 288.361L295.631 257.064L301.845 325.476L285.26 364.865L262.456 288.361Z"
                  fill="white"
                />
            ...
            <p className="text-muted-foreground leading-relaxed mb-6 font-body">
              Premium digital assets for modern developers. Built by Themes Jet.
            </p>
          ...
          {/* Marketplace Links */}
          <div>
            <h4 className="text-foreground font-bold font-heading mb-6 text-base">
              Marketplace
            </h4>
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4 font-body">
              Get the latest releases and discounts.
            </p>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted-foreground font-body">
            © 2026 Themes Jet | All rights reserved.
          </p>
