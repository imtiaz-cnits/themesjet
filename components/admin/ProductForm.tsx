      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        ...
        <div className="flex gap-3 w-full md:w-auto">
          <button
            type="button"
            onClick={() => router.back()}
            className="flex-1 md:flex-none cursor-pointer px-6 py-3 rounded-xl border border-border text-sm font-bold text-foreground hover:bg-secondary transition-colors"
          >
            Cancel
          </button>
          <button
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  type="text"
                  className="input-field w-full border border-border bg-background rounded-lg px-4 py-3"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    className="input-field w-full border border-border bg-background rounded-lg px-4 py-3 cursor-pointer"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  className="input-field w-full h-40 border border-border bg-background rounded-lg px-4 py-3 resize-none"
              ...
              <div>
                ...
                <div className="flex gap-2 mb-3">
                  <input
                    ...
                    className="flex-1 border border-border bg-background rounded-lg px-4 py-2 text-sm outline-none focus:border-primary"
                    placeholder="Add tag..."
                  />
                  <button
                    onClick={handleAddTag}
                    type="button"
                    className="bg-secondary px-4 py-2 rounded-lg font-bold text-sm"
                  >
                    Add
                  </button>
                </div>
                <div className="flex flex-wrap gap-2">
                  {tags.map((tag) => (
                    <span
                      key={tag}
                      className="bg-primary/10 text-primary text-xs font-bold px-3 py-1.5 rounded-md flex items-center gap-2"
                    >
                      {tag}{" "}
                ...
                {imageUrl ? (
                  ...
                  <UploadDropzone
                    ...
                    appearance={{
                      ...
                      button:
                        "flex-1 md:flex-none px-6 py-3 rounded-xl !bg-primary text-primary-foreground !cursor-pointer text-sm font-bold hover:!bg-primary/90 shadow-lg shadow-primary/25 transition-all flex items-center justify-center gap-2 ",
                    }}
              ...
              <div>
                ...
                {fileUrl ? (
                  <div className="flex items-center gap-4 bg-green-500/10 border border-green-500/20 p-4 rounded-xl">
                    ...
                    <span className="text-sm font-bold text-green-600 truncate flex-1">
                      {fileUrl.split("/").pop()}
                    </span>
            ...
            <div className="flex flex-col md:flex-row items-center gap-4">
              <div className="flex-1 w-full">
                ...
                <input
                  ...
                  type="number"
                  step="0.01"
                  className="input-field w-full border border-border bg-background rounded-lg px-4 py-3 font-bold text-lg"
                />
              </div>
            </div>
          </section>
