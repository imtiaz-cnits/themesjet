  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-[24px] z-40 p-2 bg-card border border-border rounded-lg shadow-md lg:hidden text-foreground"
      >
        <Menu size={24} />
      </button>
      ...
      <aside
        className={`
    fixed top-0 left-0 z-50 h-screen w-64 bg-card/95 backdrop-blur-xl border-r border-border flex flex-col transition-transform duration-300 ease-in-out
    ${isOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}

    /* Scroll Functionality */
    overflow-y-auto 

    /* Custom Scrollbar Design (Inline) */
...
`}
      >
        ...
        <div className="h-20 flex items-center justify-between px-6 border-b border-border">
          ...
          >
            ...
            >
              ...
              <path
                ...
                fill="url(#sidebar_logo_gradient)"
              />
              <path
                fillRule="evenodd"
                clipRule="evenodd"
          ...
          <button
            onClick={() => setIsOpen(false)}
            className="lg:hidden text-foreground ml-auto p-1"
          >
            <X size={24} />
          </button>
        </div>
        ...
        <div className="p-4 border-t border-border">
          <button
            ...
            className="flex items-center cursor-pointer gap-3 px-4 py-3 w-full rounded-lg text-sm font-medium text-red-500 hover:bg-red-500/10 transition-colors"
          >
            <LogOut size={18} />
            Sign Out
          </button>
