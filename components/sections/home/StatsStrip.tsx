...
export default function StatsStrip() {
  return (
    <motion.div
      ...
      className="border-y border-border bg-card/30 backdrop-blur-md relative z-10 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col lg:flex-row justify-between items-center gap-12 lg:gap-30">
          ...
          {stats.map((stat, i) => (
            <div key={stat.label} className="flex items-center gap-8">
              <div className="text-center md:text-left">
                ...
                >
                  <span className="text-3xl md:text-4xl font-bold text-foreground font-heading flex items-center justify-center md:justify-start">
                    {/* Counter Component Used Here */}
        ...
        <div className="w-full lg:w-1/2 overflow-hidden bg-transparent relative">
          {/* Gradient Masks for fade effect on edges */}
          <div className="absolute inset-y-0 left-0 w-12 z-10 opacity-50"></div>
          <div className="absolute inset-y-0 right-0 w-12 z-10 opacity-50"></div>
